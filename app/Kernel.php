...
if($action == 'showOfferAction' || $action == 'editOfferAction' || $action == 'deleteOfferAction' || $action == 'editProductAction' || $action == 'addProductAction' || $action == 'createProductAction') {
    $index = $load_new->$action($_GET['id']);
} else {
