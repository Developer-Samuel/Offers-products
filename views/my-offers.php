            ...
            <div class="container" id="white-container">
                ...
                <table class="table" id="offers-table">
                    ...
                    <thead id="main-thead" class="thead-dark">
                        ...
                        <tr>
                            <th scope="col">
                                <a href="my-offers?page=<?php echo $page; ?>&sort=offer_id&order=<?php echo ($sort == 'offer_id' && $order == 'asc') ? 'desc' : 'asc'; ?>">
                                    #
                            ...
                            <th scope="col">
                                <a href="my-offers?page=<?php echo $page; ?>&sort=offer_name&order=<?php echo ($sort == 'offer_name' && $order == 'asc') ? 'desc' : 'asc'; ?>">
                                    Offer Name
                            ...
                            <th scope="col">
                                <a href="my-offers?page=<?php echo $page; ?>&sort=customer_name&order=<?php echo ($sort == 'customer_name' && $order == 'asc') ? 'desc' : 'asc'; ?>">
                                    Customer name
                            ...
                            <th scope="col">
                                <a href="my-offers?page=<?php echo $page; ?>&sort=validity_offer&order=<?php echo ($sort == 'validity_offer' && $order == 'asc') ? 'desc' : 'asc'; ?>">
                                    Validity offer
                            ...
                            <th scope="col">
                                <a href="my-offers?page=<?php echo $page; ?>&sort=note&order=<?php echo ($sort == 'note' && $order == 'asc') ? 'desc' : 'asc'; ?>">
                                    Note
                                    <?php if ($sort == 'note') { ?>
                                        <?php if ($order == 'asc') { ?>
                                            <span class="table-arrow-up">&#129053;</span>
                ...
                <div class="pagination py-5 d-flex justify-content-sm-center">
                    <?php if ($page > 1): ?>
                        ...
                        <a id="prev" href="my-offers?page=<?php echo $page - 1; ?>">«</a>
                        <!--end::Previous button-->
                    <?php endif; ?>
                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        <!--begin::Page button-->
                        <a href="my-offers?page=<?php echo $i; ?>" <?php if ($i == $page): ?>class="active"<?php endif; ?>><?php echo $i; ?></a>
                        <!--end::Page button-->
                    <?php endfor; ?>
                    <?php if ($page < $totalPages): ?>
                        <!--begin::Next button-->
                        <a id="next" href="my-offers?page=<?php echo $page + 1; ?>">»</a>
                        <!--end::Next button-->
                    <?php endif; ?>
                </div>
                <!--end::Pagination-->
...
<script type="text/javascript" src="js/showOffer.js"></script>
